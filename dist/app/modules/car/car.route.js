...
route.put("/return", (0, auth_1.default)(user_constant_1.userRole.admin, user_constant_1.userRole.user), car_controller_1.carController.returnCar);
route.delete("/:id", (0, auth_1.default)(user_constant_1.userRole.admin), car_controller_1.carController.deleteCar);
route.put("/car-back/:id", (0, auth_1.default)(user_constant_1.userRole.admin), car_controller_1.carController.manageCarsStatusAbailable);
route.get("/", car_controller_1.carController.getCar);
route.get("/cars/:id", car_controller_1.carController.getSingleCar);
route.get("/manage-cars", car_controller_1.carController.manageCars);
